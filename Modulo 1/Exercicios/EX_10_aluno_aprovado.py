...
A = float (input("digite a nota da sua primeira prova: ") )
B = float (input("digite a nota da sua segunda prova: " ) )
print  (f"a nota final é: ",(A + B)/2)
print ("aluno aprovado?" (A + B >=5))